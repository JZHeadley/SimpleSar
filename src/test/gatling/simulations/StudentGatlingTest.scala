...
class StudentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Student entity")
        ...
        .repeat(2) {
            ...
            .post("/api/students")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "ssn":"SAMPLE_TEXT", "gender":"SAMPLE_TEXT", "phoneNumber":"SAMPLE_TEXT", "maritalStatus":"SAMPLE_TEXT", "dependent":null, "dob":"2020-01-01T00:00:00.000Z", "email":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
